/**
 */
package Particle.impl;

import Particle.Attribute;
import Particle.Method;
import Particle.ParticlePackage;
 ...
 * <ul>
 *   <li>{@link Particle.impl.MethodImpl#getFunctionalDependency <em>Functional Dependency</em>}</li>
 *   <li>{@link Particle.impl.MethodImpl#getDataDependency <em>Data Dependency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MethodImpl extends FeatureImpl implements Method {
	...
	protected EClass eStaticClass() {
		return ParticlePackage.Literals.METHOD;
	}
	...
	public EList<Method> getFunctionalDependency() {
		if (functionalDependency == null) {
			functionalDependency = new EObjectResolvingEList<Method>(Method.class, this, ParticlePackage.METHOD__FUNCTIONAL_DEPENDENCY);
		}
	...
	public EList<Attribute> getDataDependency() {
		if (dataDependency == null) {
			dataDependency = new EObjectResolvingEList<Attribute>(Attribute.class, this, ParticlePackage.METHOD__DATA_DEPENDENCY);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParticlePackage.METHOD__FUNCTIONAL_DEPENDENCY:
				return getFunctionalDependency();
			case ParticlePackage.METHOD__DATA_DEPENDENCY:
