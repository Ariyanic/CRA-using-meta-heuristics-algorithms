...
public class CRAIndexCalculator {
	...
	public static void particleRegisterPackage() {
		ParticlePackage.eINSTANCE.eClass();    
	    Resource.Factory.Registry regPar = Resource.Factory.Registry.INSTANCE;
	    Map<String, Object> mCh = regPar.getExtensionToFactoryMap();
	    mCh.put("xmi", new XMIResourceFactoryImpl());
	}

	public static void vectorRegisterPackage() {
		VelocityPackage.eINSTANCE.eClass() ;
	    Resource.Factory.Registry regVector = Resource.Factory.Registry.INSTANCE;
	    Map<String, Object> mCh = regVector.getExtensionToFactoryMap();
	    mCh.put("xmi", new XMIResourceFactoryImpl());
	}
