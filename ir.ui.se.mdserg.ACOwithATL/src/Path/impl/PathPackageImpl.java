...
public class PathPackageImpl extends EPackageImpl implements PathPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getFeature_Tau(), ecorePackage.getEDouble(), "tau", "1.0", 1, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFeature_Eta(), ecorePackage.getEDouble(), "eta", "-1000000", 1, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFeature_NumeratorP(), ecorePackage.getEDouble(), "NumeratorP", "0.0", 1, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
