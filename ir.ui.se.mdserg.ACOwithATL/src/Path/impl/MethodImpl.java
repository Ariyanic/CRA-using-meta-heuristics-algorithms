 ...
 * <ul>
 *   <li>{@link Path.impl.MethodImpl#getFunctionalDependency <em>Functional Dependency</em>}</li>
 *   <li>{@link Path.impl.MethodImpl#getDataDependency <em>Data Dependency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MethodImpl extends FeatureImpl implements Method {
	...
	protected EClass eStaticClass() {
		return PathPackage.Literals.METHOD;
	}
	...
	public EList<Method> getFunctionalDependency() {
		if (functionalDependency == null) {
			functionalDependency = new EObjectResolvingEList<Method>(Method.class, this, PathPackage.METHOD__FUNCTIONAL_DEPENDENCY);
		}
	...
	public EList<Attribute> getDataDependency() {
		if (dataDependency == null) {
			dataDependency = new EObjectResolvingEList<Attribute>(Attribute.class, this, PathPackage.METHOD__DATA_DEPENDENCY);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PathPackage.METHOD__FUNCTIONAL_DEPENDENCY:
				return getFunctionalDependency();
			case PathPackage.METHOD__DATA_DEPENDENCY:
